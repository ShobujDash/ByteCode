...
export namespace Prisma {
  ...
  */
  ...
  export type ArticlesCountOutputTypeSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    ...
    like?: boolean | ArticlesCountOutputTypeCountLikeArgs
  }
   ...
   * ArticlesCountOutputType without action
   */
  export type ArticlesCountOutputTypeCountLikeArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    where?: LikeWhereInput
  }
  ...
  export type ArticlesSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    like?: boolean | Articles$likeArgs<ExtArgs>
  ...
  export interface Prisma__ArticlesClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    like<T extends Articles$likeArgs<ExtArgs> = {}>(args?: Subset<T, Articles$likeArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$LikePayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
   ...
   * Articles.like
   */
  export type Articles$likeArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Like
     */
    select?: LikeSelect<ExtArgs> | null
  ...
  export type ArticlesCreateInput = {
    ...
    like?: LikeCreateNestedManyWithoutArticleInput
  }
  ...
  export type ArticlesUncheckedCreateInput = {
    ...
    like?: LikeUncheckedCreateNestedManyWithoutArticleInput
  }
  ...
  export type ArticlesUpdateInput = {
    ...
    like?: LikeUpdateManyWithoutArticleNestedInput
  }
  ...
  export type ArticlesUncheckedUpdateInput = {
    ...
    like?: LikeUncheckedUpdateManyWithoutArticleNestedInput
  }
  ...
  export type LikeCreateInput = {
    ...
    article: ArticlesCreateNestedOneWithoutLikeInput
  }
  ...
  export type LikeUpdateInput = {
    ...
    article?: ArticlesUpdateOneRequiredWithoutLikeNestedInput
  }
  ...
  export type ArticlesCreateNestedOneWithoutLikeInput = {
    create?: XOR<ArticlesCreateWithoutLikeInput, ArticlesUncheckedCreateWithoutLikeInput>
    connectOrCreate?: ArticlesCreateOrConnectWithoutLikeInput
    connect?: ArticlesWhereUniqueInput
  }
  ...
  export type ArticlesUpdateOneRequiredWithoutLikeNestedInput = {
    create?: XOR<ArticlesCreateWithoutLikeInput, ArticlesUncheckedCreateWithoutLikeInput>
    connectOrCreate?: ArticlesCreateOrConnectWithoutLikeInput
    upsert?: ArticlesUpsertWithoutLikeInput
    connect?: ArticlesWhereUniqueInput
    update?: XOR<XOR<ArticlesUpdateToOneWithWhereWithoutLikeInput, ArticlesUpdateWithoutLikeInput>, ArticlesUncheckedUpdateWithoutLikeInput>
  }
  ...
  export type ArticlesCreateWithoutLikeInput = {
    id?: string
    title: string
    content: string
    category: string
  ...
  export type ArticlesUncheckedCreateWithoutLikeInput = {
    id?: string
    title: string
    content: string
    category: string
  ...
  export type ArticlesCreateOrConnectWithoutLikeInput = {
    where: ArticlesWhereUniqueInput
    create: XOR<ArticlesCreateWithoutLikeInput, ArticlesUncheckedCreateWithoutLikeInput>
  }
  ...
  export type ArticlesUpsertWithoutLikeInput = {
    update: XOR<ArticlesUpdateWithoutLikeInput, ArticlesUncheckedUpdateWithoutLikeInput>
    create: XOR<ArticlesCreateWithoutLikeInput, ArticlesUncheckedCreateWithoutLikeInput>
    where?: ArticlesWhereInput
  }

  export type ArticlesUpdateToOneWithWhereWithoutLikeInput = {
    where?: ArticlesWhereInput
    data: XOR<ArticlesUpdateWithoutLikeInput, ArticlesUncheckedUpdateWithoutLikeInput>
  }

  export type ArticlesUpdateWithoutLikeInput = {
    id?: StringFieldUpdateOperationsInput | string
    title?: StringFieldUpdateOperationsInput | string
    content?: StringFieldUpdateOperationsInput | string
    category?: StringFieldUpdateOperationsInput | string
  ...
  export type ArticlesUncheckedUpdateWithoutLikeInput = {
    id?: StringFieldUpdateOperationsInput | string
    title?: StringFieldUpdateOperationsInput | string
    content?: StringFieldUpdateOperationsInput | string
    category?: StringFieldUpdateOperationsInput | string
